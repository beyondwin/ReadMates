...
- 핵심 기술 선택의 배경, trade-off, 관련 검증 명령은 [technical-decisions.md](technical-decisions.md)를 기준으로 합니다. ADR 0001~0010은 [adr/README.md](adr/README.md)에서 개별 결정 문서로 확인할 수 있습니다.
