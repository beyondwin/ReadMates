...
버전별 검토와 실제 배포 결과는 시점별 snapshot인 [2026-08-03 v2 release readiness evidence](../reports/2026-08-03-release-readiness-v2.md)에 보관합니다. 새 릴리스도 이 체크리스트 본문에 누적하지 않고 `docs/reports`의 날짜가 있는 evidence 문서에 기록합니다.
