...
- ADR-0014: OCI Compute 선택 (Cloud Run 대비) — Task 12에서 0014 번호가 BFF secret rotation lifecycle로 채택되므로 이 후보는 향후 0017+로 재배정 예정
- ADR-0016: Deploy ledger NDJSON 스키마 (Task 13에서 작성 예정)
