...
| BFF or OAuth | same-origin proxy, cookie/session, safe exact raw return path, target-club join, invite priority, trusted header stripping | BFF unit test, OAuth service/integration test, and relevant E2E flow |
