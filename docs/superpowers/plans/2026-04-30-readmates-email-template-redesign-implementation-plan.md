...
git grep -n -E 'gmail[.]com|READMATES_BFF_SECRET=<shared-bff-secret> PRIVATE KEY|app password|password=|token=' -- server front docs ':!docs/superpowers/plans/2026-04-30-readmates-email-template-redesign-implementation-plan.md' || true
```
