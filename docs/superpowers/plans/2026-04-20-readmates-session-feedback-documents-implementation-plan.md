...
- [x] Insert the full approved Markdown content from every file under `<local-user-path> into `R__readmates_dev_seed.sql` so runtime does not depend on ignored files.
