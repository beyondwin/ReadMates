...
Use this as design context alongside `docs/agents/design.md`; it does not override repository safety rules, architecture boundaries, or verification requirements. A design change is done when the target role workflow is clearer, desktop and mobile behavior have been checked, accessibility states remain visible, and no private member or deployment data has been introduced.
