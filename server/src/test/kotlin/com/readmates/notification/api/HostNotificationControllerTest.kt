...
private const val SENSITIVE_TEST_MAIL_ERROR =
    "smtp rejected external@example.com password=raw-password Bearer raw-bearer-token api_key=raw-api-key authorization=Basic raw-basic-token <private-key-marker> raw-private-key"
