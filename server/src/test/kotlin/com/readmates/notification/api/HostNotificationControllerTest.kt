...
private const val SENSITIVE_TEST_MAIL_ERROR =
    "smtp rejected external@example.com password=marker Bearer marker api_key=marker authorization=Basic marker <private-key-marker> marker"
...
class HostNotificationControllerTest(
    ...
    private fun insertNotificationEvent(
        ...
        jdbcTemplate.update(
            ...
            values (?, ?, ?, 'SESSION', '00000000-0000-0000-0000-000000000301', json_object('sessionId', '00000000-0000-0000-0000-000000000301'), ?, ?, ?)
            """.trimIndent(),
            id,
            clubId,
            eventType.name,
