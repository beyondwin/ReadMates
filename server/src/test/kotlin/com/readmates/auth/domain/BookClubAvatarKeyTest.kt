...
class BookClubAvatarKeyTest {
    ...
    fun `catalog contains exactly the fixed frontend wire set`() {
        val expectedWireValues =
            listOf(
                "globe-notebook", "mushroom-green-book", "lemon-green-book", "pudding-notebook",
                "peach-green-book", "radish-notebook", "apple-green-book", "sailboat-green-book",
                "palette-green-book", "balloon-green-book", "dumpling-notebook", "tulip-notebook",
                "cheese-green-book", "starfish-notebook", "banana-green-book", "milk-green-book",
                "cloud-green-book", "teacup-green-book", "toast-brown-book", "snowglobe-green-book",
                "cherries-notebook", "envelope-notebook", "bell-notebook", "teacup-notebook",
                "candle-green-book", "sun-green-book", "teapot-green-book", "sheep-notebook",
                "moon-green-book", "star-notebook",
            )
