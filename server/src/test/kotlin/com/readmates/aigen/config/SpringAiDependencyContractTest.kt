...
class SpringAiDependencyContractTest {
    ...
    fun `uses the Spring AI BOM and managed provider starters`() {
        ...
        assertThat(buildFile).contains("compileOnly(\"com.anthropic:anthropic-java-client-okhttp:2.40.1\")")
        assertThat(buildFile).contains("compileOnly(\"com.openai:openai-java-client-okhttp:4.39.1\")")
