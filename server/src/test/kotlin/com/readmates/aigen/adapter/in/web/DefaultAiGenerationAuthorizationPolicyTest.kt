...
private const val SEED_SQL = """
    ...
    values
      ('$HOST_MEMBERSHIP_ID', '$CLUB_ID', '$HOST_USER_ID', 'HOST', 'ACTIVE', 'AuthzHost', '2026-05-01 00:00:00.000000', 'archive-box'),
      ('$MEMBER_MEMBERSHIP_ID', '$CLUB_ID', '$MEMBER_USER_ID', 'MEMBER', 'ACTIVE', 'AuthzMember', '2026-05-01 00:00:00.000000', 'archive-box');
