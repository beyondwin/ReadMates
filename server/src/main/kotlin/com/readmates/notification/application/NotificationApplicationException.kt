...
enum class NotificationApplicationError {
    ...
    ADMIN_NOTIFICATION_REPLAY_REASON_TOO_LONG,
    ADMIN_NOTIFICATION_REPLAY_TOO_MANY_TARGETS,
    ADMIN_NOTIFICATION_REPLAY_NO_ELIGIBLE_TARGETS,
    ...
    ADMIN_NOTIFICATION_REPLAY_REPREVIEW_REQUIRED,
    ADMIN_NOTIFICATION_REPLAY_CONFIRMATION_CONFLICT,
    ADMIN_NOTIFICATION_REPLAY_INVALID_IDEMPOTENCY_KEY,
    ADMIN_NOTIFICATION_REPLAY_IDEMPOTENCY_CONFLICT,
    ADMIN_NOTIFICATION_REPLAY_IN_PROGRESS,
    ADMIN_NOTIFICATION_REPLAY_RECEIPT_INVALID,
}
