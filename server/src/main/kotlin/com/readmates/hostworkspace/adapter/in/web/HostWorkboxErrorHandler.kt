...
class HostWorkboxErrorHandler {
    ...
    fun keyNotFound(): ResponseEntity<ApiErrorResponse> =
        apiErrorResponse(
    ...
    fun invalid(): ResponseEntity<ApiErrorResponse> =
        apiErrorResponse(
    ...
    fun restart(): ResponseEntity<ApiErrorResponse> =
        apiErrorResponse(
            HttpStatus.CONFLICT,
            "WORKBOX_RESTART_REQUIRED",
            "작업함을 새로 불러와 주세요.",
        )
}
