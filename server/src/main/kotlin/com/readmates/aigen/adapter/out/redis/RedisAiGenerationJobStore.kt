    ...
    override fun saveResult(
        ...
        runCatching {
            ...
            redisTemplate.execute(
                ...
                resultJson,
                usage.publicInputTokens.toString(),
                usage.publicCachedInputTokens.toString(),
        ...
        runCatching {
            ...
            val saved =
                redisTemplate.execute(
                    ...
                    command.usage.publicInputTokens.toString(),
                    command.usage.publicCachedInputTokens.toString(),
