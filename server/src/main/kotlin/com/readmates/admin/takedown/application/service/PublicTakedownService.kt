...
import com.readmates.shared.security.MUTATION_IDENTITY_HMAC_PURPOSE
    ...
    private fun canonicalRequestHmac(
        ...
        val reasonHmac =
            RequestIdentityHmac.hmac(
                ...
                MUTATION_IDENTITY_HMAC_PURPOSE,
            )
        ...
        return RequestIdentityHmac.hmac(key, bytes.toByteArray(), MUTATION_IDENTITY_HMAC_PURPOSE)
    }
