        ...
        http
            .csrf {
                ...
                it.ignoringRequestMatchers(
                    ...
                    methodAndPath("PATCH", Regex("^/api/admin/clubs/[^/]+/metadata$")),
                    methodAndPath("POST", Regex("^/api/admin/clubs/[^/]+/visibility/(preview|confirm)$")),
                    ...
                    methodAndPath("POST", Regex("^/api/admin/clubs/[^/]+/domains/preview$")),
