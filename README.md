...
- 공통 작업 계약과 권한·local-runtime 경계: [프로젝트 지도](docs/development/project-map.md)의 공통 작업 원칙
- 변경 slice의 risk evidence 선택: [acceptance matrix](docs/development/acceptance-matrix.md)
...
| 공통 작업 원칙 | [docs/development/project-map.md](docs/development/project-map.md) |
