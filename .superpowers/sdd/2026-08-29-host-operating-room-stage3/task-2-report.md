...
| `a094b71ea4a4fe054306e5b3a82c887be6c37532dc1c1139f364bf972fe36867` (aggregate session/architecture tests) and `142155f1fd1aab378fd00713dc30e7a42759c108262541835bea0957862e6e0f` (aggregate host-workspace tests) | `./server/gradlew -p server architectureTest` | GREEN, `105/105` tests | `hostworkspace` is registered before its inbound controller. Application imports no foreign ReadMates feature, including `shared`; source adapters may reference foreign application input ports but no foreign adapter. Application feature edges and cycles do not grow. |
