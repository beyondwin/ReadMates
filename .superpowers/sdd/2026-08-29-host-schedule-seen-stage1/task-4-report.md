...
- Fixture export and determinism:
  - `PATH=<node24-bin>:$PATH npx --yes corepack@0.35.0 pnpm --dir front zod:export-fixtures`
...
- Focused RED command: `PATH=<node24-bin>:$PATH npx --yes corepack@0.35.0 pnpm --dir front exec vitest run features/host/api/host-session-recovery-contracts.test.ts features/host/api/host-api.test.ts`.
