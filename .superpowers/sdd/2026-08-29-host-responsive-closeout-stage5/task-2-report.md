...
| Task 2 source-manifest SHA-256 `72460758b584920b4a6a911f2ac1a38f6d0fe55d04abf0a97842b0e04d1310a2` | `git diff --check f8e8424266ac318fa9a0ce20cef5e84b6c9a8320 -- && if git diff --unified=0 f8e8424266ac318fa9a0ce20cef5e84b6c9a8320 -- | rg -n '^\+[^+].*(/Users/|BEGIN (RSA |EC |OPENSSH )?PRIVATE KEY|A(KIA|SIA)[0-9A-Z]{16}|ocid1\.|gh[pousr]_[A-Za-z0-9]{20,}|sk-(live|proj)-|AIza[0-9A-Za-z_-]{20,}|xox[baprs]-|https?://[^ ]+\.(internal|corp))'; then exit 1; fi` | GREEN: exit `0`, no whitespace or targeted public-safety finding | Whitespace and targeted public-repository safety closed. `gitleaks` was unavailable and is not claimed. |
