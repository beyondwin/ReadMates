...
- feat(aigen): wire live Claude SDK calls in ClaudeApiClient (task_8_1)
- feat(aigen): wire live OpenAI SDK calls in OpenAiApiClient (task_8_2)
- feat(aigen): wire live Gemini SDK calls in GeminiApiClient with operator-enforced retention policy (task_8_3)
