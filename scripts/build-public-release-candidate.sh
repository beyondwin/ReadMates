...
copy_manifest() {
  ...
  copy_required_file ".github/workflows/host-client-rollout-evidence.yml"
  ...
  copy_required_file "scripts/check-host-client-rollout-contract.py"
  copy_required_file "scripts/check-flyway-migration-immutability.py"
  copy_required_file "scripts/host-rollout-evidence-reporter.py"
  copy_required_file "scripts/host-rollout-cache-evidence.py"
  copy_required_file "scripts/host-rollout-test-contract.json"
  copy_required_file "scripts/host-rollout-workflow-contract.json"
  copy_required_file "scripts/test-host-rollout-evidence-reporter.py"
  copy_required_file "scripts/test-host-rollout-cache-evidence.py"
  copy_required_file "scripts/validate-host-rollout-candidate.py"
  copy_required_file "scripts/verify-host-client-rollout-evidence.py"
  copy_required_file "scripts/schemas/host-client-rollout-evidence-v1.schema.json"
  copy_required_file "scripts/schemas/host-rollout-test-report-v1.schema.json"
  copy_required_file "scripts/schemas/host-rollout-workflow-contract-v1.schema.json"
  copy_required_file "scripts/tooling/gh-attestation-lock.json"
