...
VARIABLE_KEYS=(
  ...
  READMATES_ADMIN_COMMAND_DIGEST_PREVIOUS_KEY_ROLLOUT_BUFFER
  ...
  READMATES_AIGEN_GROUNDED_RESERVED_OUTPUT_TOKENS
  READMATES_AIGEN_KAFKA_CONSUMER_RETRY_DELAY
  READMATES_AIGEN_KAFKA_CONSUMER_MAX_ATTEMPTS
  READMATES_AIGEN_PROCESSING_DEADLINE
  READMATES_AIGEN_RECOVERY_FIXED_DELAY
  READMATES_AIGEN_RECOVERY_BATCH_SIZE
  READMATES_AIGEN_RECOVERY_INDEX_REPAIR_BATCH_SIZE
  READMATES_AIGEN_RECOVERY_INDEX_REPAIR_MAX_MEMBERS
  READMATES_AIGEN_QUEUE_PROBE_FIXED_DELAY
  SPRING_MAIL_HOST
  READMATES_NOTIFICATION_SENDER_EMAIL
  READMATES_NOTIFICATION_SENDER_NAME
  CADDY_SITE
