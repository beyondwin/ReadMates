...
export const HOST_PREP_MOBILE_MAIN_GEOMETRY = { x: 19, y: 52, width: 352, height: 1085 } as const;
...
export const HOST_PREP_MOBILE_PHASE_PANEL_GEOMETRY = { x: 19, y: 422, width: 352, height: 267 } as const;
export const HOST_PREP_MOBILE_WORKBOX_GEOMETRY = { x: 19, y: 688, width: 352, height: 376 } as const;
