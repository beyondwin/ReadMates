...
import {
  ...
  ADMIN_CLUBS_HEADING_DESKTOP_GEOMETRY,
  ADMIN_LEDGER_DOCKET_GEOMETRY,
  ADMIN_LEDGER_LIST_GEOMETRY,
  ADMIN_NAV_MOBILE_GEOMETRY,
  ADMIN_PAGE_HEADING_DESKTOP_GEOMETRY,
  ADMIN_RECORDS_HEADING_DESKTOP_GEOMETRY,
  ADMIN_SERVICE_EVIDENCE_GEOMETRY,
  ADMIN_SERVICE_HEADING_DESKTOP_GEOMETRY,
...
export const REQUIRED_VISUAL_AUTHORITY_COVERAGE: Record<ApprovedMockupId, RequiredScenarioCoverage> = {
  ...
  "admin-clubs-desktop": {
    ...
    regions: [
      ...
      {
        name: "clubs-heading",
        selector: ".admin-club-management__docket h1",
        expected: ADMIN_CLUBS_HEADING_DESKTOP_GEOMETRY,
        toleranceCssPx: 4,
      },
      {
        name: "club-finder",
        selector: ".admin-clubs-ledger__list",
    ...
    typography: [
      TYPO_ADMIN_WORDMARK,
      typo("page-title", ".admin-club-management__docket h1", 24, [600, 700], 31.2),
      typo("row-title", ".admin-club-management__row", 17, [600], 23.8),
      TYPO_BODY,
    ],
    firstViewport: [
      { name: "finder", selector: ".admin-clubs-ledger__list", visibility: "fully-visible" },
  ...
  "admin-service-desktop": {
    ...
    regions: [
      ...
      ADMIN_RAIL,
      {
        ...
        selector: "section.admin-service-status",
        expected: ADMIN_SERVICE_HEADING_DESKTOP_GEOMETRY,
        toleranceCssPx: 4,
      },
      {
        name: "service-table",
        selector: "section.admin-service-status table",
      ...
      },
      {
        ...
        expected: ADMIN_SERVICE_EVIDENCE_GEOMETRY,
        toleranceCssPx: 4,
      },
    ],
    typography: [
      TYPO_ADMIN_WORDMARK,
      typo("page-title", "section.admin-service-status th", 16, [500, 600], 22.4),
      typo("row-title", ".admin-service-status__row", 17, [600], 23.8),
      TYPO_BODY,
    ],
    firstViewport: [
      { name: "service-table", selector: "section.admin-service-status table", visibility: "fully-visible" },
      { name: "service-evidence", selector: ".admin-health-grid__strip", visibility: "intersects" },
      { name: "row-recheck", selector: 'role=button[name="새로 확인"]', visibility: "fully-visible" },
    ],
    defaultVisibleItems: undefined,
    interactions: [
      {
  ...
  "admin-records-desktop": {
    ...
    regions: [
      ...
      ADMIN_RAIL,
      {
        ...
        selector: ".admin-audit__detail h1",
        expected: ADMIN_RECORDS_HEADING_DESKTOP_GEOMETRY,
        toleranceCssPx: 4,
      },
      {
        name: "audit-list",
    ...
    typography: [
      TYPO_ADMIN_WORDMARK,
      typo("page-title", ".admin-audit__detail h1", 24, [600, 700], 31.2),
