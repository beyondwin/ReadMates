...
import {
  ...
  HOST_PEOPLE_NAV_GEOMETRY,
  HOST_PERSON_HEADER_GEOMETRY,
  ...
  HOST_SCHEDULE_REVIEW_HEADER_GEOMETRY,
  HOST_SCHEDULE_REVIEW_MAIN_GEOMETRY,
  HOST_SCHEDULE_REVIEW_NAV_GEOMETRY,
...
const HOST_NAV = {
  ...
  expected: HOST_MEETINGS_NAV_GEOMETRY,
  toleranceCssPx: 4 as const,
};
...
const HOST_MOBILE_HEADER = {
  name: "mobile-header",
  selector: '[data-club-shell-region="mobile-context"]',
...
export const REQUIRED_VISUAL_AUTHORITY_COVERAGE: Record<ApprovedMockupId, RequiredScenarioCoverage> = {
  ...
  "host-meetings-desktop": {
    ...
    preparationKey: "none",
    regions: [
      { name: "host-header", selector: "header.topnav", expected: HOST_MEETINGS_HEADER_GEOMETRY, toleranceCssPx: 4 },
      { name: "host-nav", selector: 'nav[aria-label="호스트 주 메뉴"]', expected: HOST_MEETINGS_NAV_GEOMETRY, toleranceCssPx: 4 },
      {
        name: "meetings-heading",
        selector: "main h1",
        expected: { x: 0, y: 91, width: 1536, height: 80 },
        toleranceCssPx: 4,
      },
      {
        name: "meeting-tabs",
        selector: '[role="tablist"][aria-label="모임 보기 방식"]',
        expected: { x: 36, y: 171, width: 1464, height: 44 },
        toleranceCssPx: 4,
      },
      { name: "meeting-ledger", selector: "main", expected: HOST_MEETINGS_MAIN_GEOMETRY, toleranceCssPx: 4 },
    ],
    typography: [
      TYPO_HOST_WORDMARK,
      TYPO_HOST_PAGE_TITLE,
      typo("tab-label", '[role="tablist"] [role="tab"]', 14, [600], 19.6),
      typo("row-title", ".rm-meeting-toc__row, .rm-host-editorial-ledger__row", 17, [600], 23.8),
      TYPO_BODY,
    ],
    firstViewport: [
  ...
  "host-people-desktop": {
    ...
    preparationKey: "none",
    regions: [
      { name: "host-header", selector: "header.topnav", expected: HOST_PEOPLE_HEADER_GEOMETRY, toleranceCssPx: 4 },
      { name: "host-nav", selector: 'nav[aria-label="호스트 주 메뉴"]', expected: HOST_PEOPLE_NAV_GEOMETRY, toleranceCssPx: 4 },
      {
        name: "people-heading",
        selector: "main h1",
        expected: { x: 0, y: 91, width: 1536, height: 80 },
      ...
      },
      {
        ...
        expected: { x: 36, y: 171, width: 1464, height: 120 },
        toleranceCssPx: 4,
      },
      { name: "member-table", selector: "main", expected: HOST_PEOPLE_MAIN_GEOMETRY, toleranceCssPx: 4 },
    ],
    typography: [
      TYPO_HOST_WORDMARK,
      TYPO_HOST_PAGE_TITLE,
    ...
    interactions: [
      {
        name: "select-member",
        kind: "activate",
        target: ".rm-host-member-ledger__person-link",
        via: "click",
      ...
      },
      {
        ...
        kind: "history-restore",
        activate: ".rm-host-member-ledger__person-link",
        ...
        expectedRestoredFocusAfterBack: ".rm-host-member-ledger__person-link",
        restoreCanonicalState: true,
      },
      {
  ...
  "host-records-desktop": {
    ...
    preparationKey: "none",
    regions: [
      { name: "host-header", selector: "header.topnav", expected: HOST_RECORDS_HEADER_GEOMETRY, toleranceCssPx: 4 },
      { name: "host-nav", selector: 'nav[aria-label="호스트 주 메뉴"]', expected: HOST_RECORDS_NAV_GEOMETRY, toleranceCssPx: 4 },
      {
        name: "records-heading",
        selector: "main h1",
        expected: { x: 0, y: 91, width: 1536, height: 80 },
      ...
      { name: "record-ledger", selector: "main", expected: HOST_RECORDS_MAIN_GEOMETRY, toleranceCssPx: 4 },
      {
        name: "closing-link",
        selector: 'role=link[name=/마감실 열기/]',
        expected: { x: 36, y: 171, width: 280, height: 44 },
        toleranceCssPx: 4,
      },
    ],
    typography: [
    ...
    firstViewport: [
      ...
      { name: "closing-link", selector: 'role=link[name=/마감실 열기/]', visibility: "fully-visible" },
    ],
    defaultVisibleItems: undefined,
    interactions: [
      {
      ...
      },
      {
        ...
        kind: "history-restore",
        activate: 'role=link[name=/마감실 열기/]',
        ...
        expectedRestoredFocusAfterBack: 'role=link[name=/마감실 열기/]',
        restoreCanonicalState: true,
      },
      {
  ...
  "host-settings-desktop": {
    ...
    preparationKey: "none",
    regions: [
      { name: "host-header", selector: "header.topnav", expected: HOST_SETTINGS_HEADER_GEOMETRY, toleranceCssPx: 4 },
      { name: "host-nav", selector: 'nav[aria-label="호스트 주 메뉴"]', expected: HOST_SETTINGS_NAV_GEOMETRY, toleranceCssPx: 4 },
      {
      ...
      },
      {
        ...
        expected: { x: 36, y: 171, width: 1464, height: 240 },
        toleranceCssPx: 4,
      },
      { name: "club-settings", selector: "main", expected: HOST_SETTINGS_MAIN_GEOMETRY, toleranceCssPx: 4 },
    ],
    typography: [
      TYPO_HOST_WORDMARK,
      TYPO_HOST_PAGE_TITLE,
  ...
  "host-schedule-review-desktop": {
    ...
    regions: [
      { name: "host-header", selector: "header.topnav", expected: HOST_SCHEDULE_REVIEW_HEADER_GEOMETRY, toleranceCssPx: 4 },
      {
        name: "host-nav",
        selector: 'nav[aria-label="호스트 주 메뉴"]',
        expected: HOST_SCHEDULE_REVIEW_NAV_GEOMETRY,
        toleranceCssPx: 4,
      },
      {
        name: "review-heading",
      ...
      },
      {
        ...
        expected: { x: 36, y: 171, width: 720, height: 720 },
        toleranceCssPx: 4,
      },
      {
        name: "preview-region",
        selector: ".rm-schedule-review__composer",
        expected: HOST_SCHEDULE_REVIEW_MAIN_GEOMETRY,
        toleranceCssPx: 4,
      },
    ],
    typography: [
    ...
    firstViewport: [
      ...
      { name: "preview-confirmation", selector: ".rm-schedule-review__layout--previewed, .rm-schedule-review__preview", visibility: "fully-visible" },
    ],
    defaultVisibleItems: undefined,
    interactions: [
      {
  ...
  "host-person-mobile": {
    ...
    regions: [
      ...
      },
      {
        ...
        expected: HOST_PERSON_MAIN_GEOMETRY,
        toleranceCssPx: 4,
      },
      HOST_MOBILE_NAV,
    ],
