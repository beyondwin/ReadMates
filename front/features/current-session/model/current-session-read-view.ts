...
export const memberCurrentSessionReadPage: MemberCurrentSessionReadPage = (response, capabilities) => {
...
export const guestCurrentSessionReadPage: GuestCurrentSessionReadPage = (response) => {
  if (response.currentSession === null) {
    return { currentSession: null };
  }
