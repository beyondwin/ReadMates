...
describe("host invitation link contracts", () => {
  it("accepts the strict privacy-safe list and one-time create shapes", () => {
    ...
    expect(HostInvitationLinkCreateResultSchema.parse({ link, oneTimeSharePath: `/clubs/reading-sai/invite/lnk_${"a".repeat(43)}`, receipt: { receiptId: "00000000-0000-0000-0000-000000000702", action: "CREATED", linkId: link.linkId, revision: 2, replayed: false } }).oneTimeSharePath).toContain("/invite/lnk_");
  });
