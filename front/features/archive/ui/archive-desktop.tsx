...
import { EmptyState, LoadMoreButton, type LoadMoreCallback } from "./archive-empty-state";

type ArchiveSelectedSectionComponent = ({ view, children }: { view: ArchiveView; children: ReactNode }) => ReactNode;
...
export function ArchiveDesktop({
  ...
  SelectedSection: ArchiveSelectedSectionComponent;
