...
function unavailableMemberDetailTarget(pathname: string) {
  ...
  return [
    ...
    scopedMemberRoute({
      ...
      load: async () => {
        ...
        return { Component, loader: memberSessionDetailLoaderFactory(queryClient, unavailableMemberDetailTarget) };
      },
    }),
    scopedMemberRoute({
...
function memberAppRoutes(queryClient: QueryClient, options: { includeIndex?: boolean; scoped?: boolean } = {}): RouteObject[] {
  ...
  return [
    ...
    },
    {
      ...
      loader: scoped
        ? scopedGuestRouteLoader(async () => (await import("@/features/archive/route/member-session-detail-data")).memberSessionDetailLoaderFactory(queryClient, unavailableMemberDetailTarget))
        : undefined,
      lazy: async () => {
        ...
        return {
          ...
          ...(scoped ? {} : { loader: memberSessionDetailLoaderFactory(queryClient, unavailableMemberDetailTarget) }),
        };
      },
    },
    {
