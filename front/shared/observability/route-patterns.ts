...
const routeRules: PatternRule[] = [
  ...
  { pattern: "/app/host/sessions", regex: /^\/app\/host\/sessions\/?$/ },
  ...
  { pattern: "/app/host/sessions/:sessionId/feedback-document", regex: /^\/app\/host\/sessions\/[^/]+\/feedback-document\/?$/ },
  { pattern: "/app/host/sessions/:sessionId/edit", regex: /^\/app\/host\/sessions\/[^/]+\/edit\/?$/ },
  { pattern: "/app/host/sessions/:sessionId", regex: /^\/app\/host\/sessions\/[^/]+\/?$/ },
  ...
  { pattern: "/clubs/:slug/app/host/sessions", regex: /^\/clubs\/[^/]+\/app\/host\/sessions\/?$/ },
  ...
  {
    pattern: "/clubs/:slug/app/host/sessions/:sessionId/feedback-document",
    regex: /^\/clubs\/[^/]+\/app\/host\/sessions\/[^/]+\/feedback-document\/?$/,
  },
  {
  ...
  {
    pattern: "/clubs/:slug/app/host/sessions/:sessionId",
    regex: /^\/clubs\/[^/]+\/app\/host\/sessions\/[^/]+\/?$/,
  },
